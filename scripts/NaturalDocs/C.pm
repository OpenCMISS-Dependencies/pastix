...
package NaturalDocs::Languages::C;
...
#
#   Overridden to support end lines comments
#
sub PreprocessFile #(lines)
    ...
    for (my $i = 0; $i < scalar @$lines; $i++)
        {
	    if ($lines->[$i] =~ /^[ \t]*([_a-zA-Z][_a-zA-Z0-9]*)([ \t\*]*)([_a-zA-Z][_a-zA-Z0-9]*)[ \t]*;[ \t]*\/\*\+(.*)\*\//)
	    {

		@newLines[$newLineNbr] = "/*";
		#print @newLines[$newLineNbr]."\n";
		$newLineNbr++;

		@newLines[$newLineNbr] = "  variable: $3";
		#print @newLines[$newLineNbr]."\n";
		$newLineNbr++;
	    ...
	    {
		if (($lines->[$i] =~ /^[ \t]*([_a-zA-Z][_a-zA-Z0-9]*) ([ \t\*]*)([_a-zA-Z][_a-zA-Z0-9]*)([ \t*]*)([_a-zA-Z][_a-zA-Z0-9]*)[ \t]*;[ \t]*\/\*\+(.*)\*\//) && (exists $variableModifiers{lc($1)} || exists $variableModifiers{lc($3)}))
		{
		    ...
		    @newLines[$newLineNbr] = "  variable: $5";
		    #print @newLines[$newLineNbr]."\n";
		    $newLineNbr++;
