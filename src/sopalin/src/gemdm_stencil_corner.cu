...
#if   (version == trans_nn)
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_nn)
#elif (version == trans_nt)
#define TRANS_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_nt)
#elif (version == trans_nc)
#define TRANS_B
#define CONJ_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_nc)
#elif (version == trans_tn)
#define TRANS_A
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_tn)
#elif (version == trans_tt)
#define TRANS_A
#define TRANS_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_tt)
#elif (version == trans_tc)
#define TRANS_A
#define TRANS_B
#define CONJ_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_tc)
#elif (version == trans_cn)
#define TRANS_A
#define CONJ_A
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_cn)
#elif (version == trans_ct)
#define TRANS_A
#define CONJ_A
#define TRANS_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_ct)
#elif (version == trans_cc)
#define TRANS_A
#define CONJ_A
#define TRANS_B
#define CONJ_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemdm_corner_cc)
#endif
		      ...
		      int blocknbr, const int *blocktab, int fblocknbr, const int *fblocktab)
{
    ...
    int blx = M/BLK_M; //blockIdx.x;
    int bly = N/BLK_N; //blockIdx.y;
