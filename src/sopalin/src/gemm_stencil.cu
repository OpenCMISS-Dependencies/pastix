//pas de tests sur M ou N
//doit être lancé sur un multiple de BLK_M*BLK_N
...
#if   (version == trans_nn)
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_nn)
#elif (version == trans_nt)
#define TRANS_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_nt)
#elif (version == trans_nc)
#define TRANS_B 
#define CONJ_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_nc)
#elif (version == trans_tn)
#define TRANS_A
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_tn)
#elif (version == trans_tt)
#define TRANS_A
#define TRANS_B 
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_tt)
#elif (version == trans_tc)
#define TRANS_A
#define TRANS_B
#define CONJ_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_tc)
#elif (version == trans_cn)
#define TRANS_A
#define CONJ_A
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_cn)
#elif (version == trans_ct)
#define TRANS_A
#define CONJ_A
#define TRANS_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_ct)
#elif (version == trans_cc)
#define TRANS_A
#define CONJ_A
#define TRANS_B
#define CONJ_B
#define kernel_name GENERATE_SM_VERSION_KERNEL_NAME(gemm_cc)
#endif
